...
(function() {
    ...
    function J(a, c, b, d) {
        return a.addEventListener ? (a.addEventListener(c, b, d || !1),
            b) : a.attachEvent ? (d = function(d) {
            d = d || window.event;
    ...
    function Ra(a) {
        if (!Aa) {
            var c = !1
                , b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "https://canvasjs.com/",
            ...
            if (a.creditHref && a.creditText) {
                ...
                a._creditLink && a.creditHref && a.creditText ? (a._creditLink.parentElement || a._canvasJSContainer.appendChild(a._creditLink),
    ...
    function R(a, c, b) {
        c.getAttribute("state") !== b && (c.setAttribute("state", b),
            ...
            c.innerHTML = "<img style='height:16px;' src='" + Sa[b].image + "' alt='" + a._cultureInfo[b + "Text"] + "' />")
    }
    function ta() {
    ...
    function B(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas),
                ...
                Ia(this.ctx),
                t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = fa(d, f),
                ...
                this._eventManager = new la(this),
                ...
                this.toolTip = new Q(this,this.options.toolTip),
                this.data = null,
                this.axisX = [],
                this.axisX2 = [],
                this.axisY = [],
    ...
    function Ca(a, c) {
        Ca.base.constructor.call(this, c);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx
    }
    ...
    function C(a, c, b, d, f) {
        ...
        y(this.chart.sessionVariables.axisX[f]) && (this.chart.sessionVariables.axisX[f] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisX[f]) : (this.optionsName = "axisX2",
        y(this.chart.sessionVariables.axisX2[f]) && (this.chart.sessionVariables.axisX2[f] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisX2[f]),
        this.options.interval || (this.intervalType = null),
        "theme2" === this.chart.theme && y(this.options.lineThickness) && (this.lineThickness = 2)) : "left" === d || "top" === d ? (this.optionsName = "axisY",
        y(this.chart.sessionVariables.axisY[f]) && (this.chart.sessionVariables.axisY[f] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisY[f]) : (this.optionsName = "axisY2",
        y(this.chart.sessionVariables.axisY2[f]) && (this.chart.sessionVariables.axisY2[f] = {}),
    ...
    function la(a) {
        ...
        this.ghostCanvas = fa(this.chart.width, this.chart.height);
    ...
    var A = {}
        ...
        for (var w = 0; h && w < h.length; w++)
            if (c = h[w],
                ...
                0 > l ? (m.push(c),
                    "#" === c || "0" === c ? n++ : "," === c && q++) : (p.push(c),
                "#" !== c && "0" !== c || e++)
            }
        r && (c = Math.floor(a),
            h = -Math.floor(Math.log(a) / Math.LN10 + 1),
            s = 0 === a ? 0 : 0 === c ? -(n + h) : String(c).length - n,
            k /= Math.pow(10, s));
        0 > l && (l = w);
        k = (a * k).toFixed(e);
        c = k.split(".");
            ...
            if (c = m.pop(),
                ...
                if (l++,
                    ...
                    var u = k
                        , k = [];
                    if ("0" === c)
                        for (c = n - e - (u ? u.length : 0); 0 < c; )
                            u.unshift("0"),
                                c--;
                    for (; 0 < u.length; )
                        b = u.pop() + b,
                            r++,
                        0 === r % h && (w === q && 0 < u.length) && (b = g + b)
                } else
                    0 < k.length ? (b = k.pop() + b,
                        ...
                        r++) : "0" === c && (b = "0" + b,
                            e++,
                            r++),
                    0 === r % h && (w === q && 0 < k.length) && (b = g + b);
            else
                "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (w++,
                    h = r,
                    r = 0,
        ...
        for (m = !1; 0 < p.length; )
            c = p.shift(),
                "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (g += a.shift(),
                    m = !0) : "0" === c && (g += "0",
                        m = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? g += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? g += c : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""),
                    g += c.replace(/[0]+/, function(a) {
                        return O(s, a.length)
                    }));
        b += (m ? f : "") + g;
        return d ? "-" + b : b
    ...
    (function() {
        ...
        A.fAWm = function(a) {
            if ("undefined" === typeof A.pro.sCH && !Aa) {
                ...
                c[A.fSDec(A.str.fTx)](A.fSDec(''), 2, a.height - 11 - 2)
            }
        }
    })();
    (function() {
                ...
                try {
                    ...
                    a: {
                        ...
                        if (f && 0 < f.length || g) {
                            var k, b = [], h = [], l = null;
                            if (f)
                                for (var m = f[0].split("; "), f = 0; f < m.length; f++)
                                    b.push(m[f].split("=")[0]),
                                        h.push(m[f].split("=")[1]);
                            g && (l = g);
                            k = {
                            ...
                            if (!y(ja[A.ckDec(A.str.sk)]) && "string" === typeof ja[A.ckDec(A.str.sk)] && ja[A.ckDec(A.str.sk)]) {
                                var e = ja[A.ckDec(A.str.sk)]
                                    , d = [];
                                k = [];
                                for (var m = 0, b = f = "", q = e.substr(e.length - 3, e.length), h = 0; h < e.length - 3; h++)
                                    d.push(parseInt(e.charCodeAt(h)) - 59),
                                        f += String.fromCharCode(d[h]),
                                        m += parseInt(parseInt(f.charCodeAt(h)) + 59, 10);
                                m %= 256;
                                m = 99 < m ? "" + m : 9 < m ? "0" + m : "00" + m;
                                for (h = 0; h < q.length; h++)
                                    k.push(parseInt(q.charCodeAt(h)) - 59),
                                        b += String.fromCharCode(k[h]);
                                n = m === b ? f : 0
                            } else
                                n = 0;
        ...
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(),
                ...
                var c = this.parent.options[this.optionsName]
                    , b = c.length;
                this.options._isPlaceholder || (qa(c),
    ...
    B.prototype._updateOptions = function() {
        ...
        this.options.zoomEnabled ? (this._zoomButton || (Z(this._zoomButton = document.createElement("button")),
            R(this, this._zoomButton, "pan"),
            this._toolBar.appendChild(this._zoomButton),
            J(this._zoomButton, "click", function() {
                a.zoomEnabled ? (a.zoomEnabled = !1,
                    a.panEnabled = !0,
                    R(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
                    a.panEnabled = !1,
                    R(a, a._zoomButton, "pan"));
                a.render()
            })),
        this._resetButton || (Z(this._resetButton = document.createElement("button")),
            R(this, this._resetButton, "reset"),
        ...
        "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? R(a, a._zoomButton, "zoom") : R(a, a._zoomButton, "pan"),
        a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && R(a, a._resetButton, "reset"));
    ...
    B.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * P || this.canvas.height !== c * P ? (ra(this.canvas, a, c),
            ra(this.overlaidCanvas, a, c),
            ra(this._eventManager.ghostCanvas, a, c),
            !0) : !1
    }
    ;
    B.prototype._initialize = function() {
        ...
        if (this.options.data)
            for (var c = 0; c < this.options.data.length; c++)
                if (a++,
                    !this.options.data[c].type || 0 <= B._supportedChartTypes.indexOf(this.options.data[c].type)) {
    ...
    B.prototype.render = function(a) {
                    ...
                    if (this.options.axisY && 0 < this.options.axisY.length) {
                        if (!this.axisY.length)
                            for (var b = 0; b < this.options.axisY.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new C(this,this.options.axisY[b],"axisY","left",b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[b] = new C(this,this.options.axisY[b],"axisY","bottom",b));
                        ...
                        this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new C(this,this.options.axisY,"axisY","left",0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new C(this,this.options.axisY,"axisY","bottom",0))),
                    ...
                    if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                        if (!this.axisY2.length)
                            for (b = 0; b < this.options.axisY2.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new C(this,this.options.axisY2[b],"axisY","right",b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new C(this,this.options.axisY2[b],"axisY","top",b));
                        ...
                        this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new C(this,this.options.axisY2,"axisY","right",0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new C(this,this.options.axisY2,"axisY","top",0))),
                    ...
                    if (this.options.axisX && 0 < this.options.axisX.length) {
                        if (!this.axisX.length)
                            for (b = 0; b < this.options.axisX.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new C(this,this.options.axisX[b],"axisX","bottom",b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[b] = new C(this,this.options.axisX[b],"axisX","left",b));
                        ...
                        this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new C(this,this.options.axisX,"axisX","bottom",0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new C(this,this.options.axisX,"axisX","left",0))),
                    ...
                    if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                        if (!this.axisX2.length)
                            for (b = 0; b < this.options.axisX2.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new C(this,this.options.axisX2[b],"axisX","top",b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new C(this,this.options.axisX2[b],"axisX","right",b));
                        ...
                        this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new C(this,this.options.axisX2,"axisX","top",0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new C(this,this.options.axisX2,"axisX","right",0))),
        ...
        b ? ta(this._zoomButton, this._resetButton) : (Z(this._zoomButton, this._resetButton),
        this.options.zoomEnabled && (this.zoomEnabled = !0,
            this.panEnabled = !1));
        this._processData();
        this.options.title && (this.title = new ma(this,this.options.title),
            this.title.dockInsidePlotArea ? c.push(this.title) : this.title.render());
        if (this.options.subtitles)
            for (this.subtitles = [],
                     a = 0; a < this.options.subtitles.length; a++)
                b = new va(this,this.options.subtitles[a]),
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var c = this.plotInfo.plotTypes[a], g = 0; g < c.plotUnits.length; g++) {
                var k = c.plotUnits[g]
                    , h = null;
                k.targetCanvas = null;
                this.animatedRender && (k.targetCanvas = fa(this.width, this.height),
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = fa(this.width, this.height).getContext("2d"),
    ...
    B.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c],
                a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= B._supportedChartTypes.indexOf(a.type)) {
    ...
    B.prototype._processMultiseriesPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
                var h = this.data[a.dataSeriesIndexes[k]], l = 0, m = !1, p = !1, n;
                ...
                for (l = 0; l < h.dataPoints.length; l++) {
                    ...
                    if (0 < l) {
                        if (a.axisX.logarithmic) {
                            ...
                            r = d - h.dataPoints[l - 1].x,
                            0 > r && (r *= -1),
                            b.minDiff > r && 0 !== r && (b.minDiff = r);
                        null !== f && null !== h.dataPoints[l - 1].y && (a.axisY.logarithmic ? (r = f / h.dataPoints[l - 1].y,
                        1 > r && (r = 1 / r),
                        c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = f - h.dataPoints[l - 1].y,
                        0 > r && (r *= -1),
                    ...
                    if (d < e && !m)
                        ...
                        null === f ? b.viewPortMin === d && n < d && (b.viewPortMin = n) : (f < c.viewPortMin && "number" === typeof f && (c.viewPortMin = f),
                        f > c.viewPortMax && "number" === typeof f && (c.viewPortMax = f))
                    }
                }
    ...
    B.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = [], h = [], l = Infinity, m = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var n = this.data[a.dataSeriesIndexes[p]], e = 0, q = !1, r = !1, s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
                    var w = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                ...
                if (n.dataPoints[e].x && n.dataPoints[e].x.getTime || "dateTime" === n.xValueType)
                    g = !0;
                for (e = 0; e < n.dataPoints.length; e++) {
                    "undefined" === typeof n.dataPoints[e].x && (n.dataPoints[e].x = e + (a.axisX.logarithmic ? 1 : 0));
                    n.dataPoints[e].x.getTime ? (g = !0,
                        d = n.dataPoints[e].x.getTime()) : d = n.dataPoints[e].x;
                    ...
                    if (0 < e) {
                        if (a.axisX.logarithmic) {
                            ...
                            v = d - n.dataPoints[e - 1].x,
                            0 > v && (v *= -1),
                            b.minDiff > v && 0 !== v && (b.minDiff = v);
                        null !== f && null !== n.dataPoints[e - 1].y && (a.axisY.logarithmic ? 0 < f && (v = f / n.dataPoints[e - 1].y,
                            1 > v && (v = 1 / v),
                            c.minDiff > v && 1 !== v && (c.minDiff = v)) : (v = f - n.dataPoints[e - 1].y,
                        0 > v && (v *= -1),
                        c.minDiff > v && 0 !== v && (c.minDiff = v)))
                    }
                    if (d < w && !q)
                        null !== n.dataPoints[e].y && (s = d);
                    else {
                        if (!q && (q = !0,
                            0 < e)) {
                            e -= 2;
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === n.dataPoints[e].y ? b.viewPortMin === d && s < d && (b.viewPortMin = s) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f),
                            0 <= f ? k[d] ? k[d] += f : (k[d] = f,
                                l = Math.min(f, l)) : h[d] ? h[d] += f : (h[d] = f,
                                m = Math.max(f, m)))
                    }
                }
            ...
            for (e in k)
                k.hasOwnProperty(e) && !isNaN(e) && (a = k[e],
                a < c.min && (c.min = Math.min(a, l)),
                a > c.max && (c.max = a),
                e < b.viewPortMin || e > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, l)),
                a > c.viewPortMax && (c.viewPortMax = a)));
            for (e in h)
                h.hasOwnProperty(e) && !isNaN(e) && (a = h[e],
                a < c.min && (c.min = a),
                a > c.max && (c.max = Math.max(a, m)),
                e < b.viewPortMin || e > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = a),
                a > c.viewPortMax && (c.viewPortMax = Math.max(a, m))))
        }
    }
    ;
    B.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = !1, h = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                for (n = 0; n < p.dataPoints.length; n++) {
                    ...
                    p.dataPoints[n].x.getTime ? (g = !0,
                        d = p.dataPoints[n].x.getTime()) : d = p.dataPoints[n].x;
                    ...
                    if (0 < n) {
                        if (a.axisX.logarithmic) {
                            ...
                            u = d - p.dataPoints[n - 1].x,
                            0 > u && (u *= -1),
                            b.minDiff > u && 0 !== u && (b.minDiff = u);
                        y(f) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < f && (u = f / p.dataPoints[n - 1].y,
                            1 > u && (u = 1 / u),
                            c.minDiff > u && 1 !== u && (c.minDiff = u)) : (u = f - p.dataPoints[n - 1].y,
                        0 > u && (u *= -1),
                    ...
                    if (d < s && !e)
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === f ? b.viewPortMin === d && r < d && (b.viewPortMin = r) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f),
                            0 <= f ? k = !0 : 0 > f && (h = !0),
            ...
            a.axisY.logarithmic ? (c.max = y(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
                c.min = y(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && !h ? (c.max = y(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99),
                c.min = y(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && h ? (c.max = y(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99),
                c.min = y(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !k && h && (c.max = y(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1),
                    c.min = y(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
            c.viewPortMin = c.min;
            c.viewPortMax = c.max;
            a.dataPointYSums = l
        }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, k, h = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    g < c.min && (c.min = g);
                    k > c.max && (c.max = k);
                    0 < p && (a.axisX.logarithmic ? (r = d / m.dataPoints[p - 1].x,
                    1 > r && (r = 1 / r),
                    b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = d - m.dataPoints[p - 1].x,
                    0 > r && (r *= -1),
                    b.minDiff > r && 0 !== r && (b.minDiff = r)),
                    f && (null !== f[0] && m.dataPoints[p - 1].y && null !== m.dataPoints[p - 1].y[0]) && (a.axisY.logarithmic ? (r = f[0] / m.dataPoints[p - 1].y[0],
                    1 > r && (r = 1 / r),
                    c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = f[0] - m.dataPoints[p - 1].y[0],
                    0 > r && (r *= -1),
                    c.minDiff > r && 0 !== r && (c.minDiff = r))));
                    if (!(d < w) || n) {
                        if (!n && (n = !0,
                        ...
                        null === f ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (g < c.viewPortMin && (c.viewPortMin = g),
    ...
    B.prototype._mouseEventHandler = function(a) {
        ...
        B.capturedEventParam && (d = B.capturedEventParam,
        "mouseup" === b && (B.capturedEventParam = null,
                    ...
                    for (var g = 0; g < this._events.length; g++)
                        if (this._events[g].hasOwnProperty(b))
                            if (d = this._events[g],
                                ...
                                "mousedown" === b && !0 === d.capture ? (B.capturedEventParam = d,
    ...
    B.prototype._plotAreaMouseUp = function(a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                k && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ta(this._zoomButton, this._resetButton),
                    R(this, this._zoomButton, "pan"),
                    R(this, this._resetButton, "reset")))
            }
        }
    ...
    B.prototype.validateRegion = function(a, c, b, d, f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), k = 0 <= this.zoomType.indexOf("y"), h = !1, l = [], m = [], p = [], n = 0; n < this.axisX.length; n++)
            this.axisX[n] && g && m.push(this.axisX[n]);
        for (n = 0; n < this.axisX2.length; n++)
            this.axisX2[n] && g && m.push(this.axisX2[n]);
        for (n = 0; n < this.axisY.length; n++)
            this.axisY[n] && k && m.push(this.axisY[n]);
        for (n = 0; n < this.axisY2.length; n++)
            this.axisY2[n] && k && m.push(this.axisY2[n]);
        for (g = 0; g < m.length; g++) {
            ...
            if (isFinite(k.dataInfo.minDiff))
                if (!(k.logarithmic && e / n < Math.pow(k.dataInfo.minDiff, 3) || !k.logarithmic && Math.abs(e - n) < 3 * Math.abs(k.dataInfo.minDiff) || n < k.minimum || e > k.maximum))
                    l.push(k),
                        p.push({
                            val1: n,
                            val2: e
    ...
    B.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            var m = this._indexLabels[a], p = m.chartType.toLowerCase(), n, e, h = K("indexLabelFontColor", m.dataPoint, m.dataSeries), l = K("indexLabelFontSize", m.dataPoint, m.dataSeries);
            ...
            if (null !== z && "" !== z) {
                ...
                if ("stackedarea100" === p) {
                    ...
                    continue;
                f = k = 2;
                "horizontal" === v ? (h = q.width,
                    l = q.height) : (l = q.width,
                    h = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    "inside" !== u ? (f = b.y1,
                        g = b.y2,
                        0 < x ? (e = m.point.y - l - k - d,
                        e < f && (e = "auto" === u ? Math.max(m.point.y, f) + k + d : f + k + d,
                            B = e + l > m.point.y)) : (e = m.point.y + k + d,
                        e > g - l - k - d && (e = "auto" === u ? Math.min(m.point.y, g) - l - k - d : g - l - k - d,
                            B = e < m.point.y))) : (f = Math.max(m.bounds.y1, b.y1),
                        g = Math.min(m.bounds.y2, b.y2),
                        d = 0 <= p.indexOf("range") ? 0 < x ? Math.max(m.bounds.y1, b.y1) + l / 2 + k : Math.min(m.bounds.y2, b.y2) - l / 2 - k : (Math.max(m.bounds.y1, b.y1) + Math.min(m.bounds.y2, b.y2)) / 2,
                        0 < x ? (e = Math.max(m.point.y, d) - l / 2,
                        e < f && ("bubble" === p || "scatter" === p) && (e = Math.max(m.point.y - l - k, b.y1 + k))) : (e = Math.min(m.point.y, d) - l / 2,
                        e > g - l - k && ("bubble" === p || "scatter" === p) && (e = Math.min(m.point.y + k, b.y2 - l - k))),
                        e = Math.min(e, g - l))
                } else
                    0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (u = "auto",
                        f = 4) : 0 <= p.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === p && (u = "inside"),
                        e = m.point.y - l / 2,
                        "inside" !== u ? (k = b.x1,
                            g = b.x2,
                            0 > x ? (n = m.point.x - h - f - d,
                            n < k && (n = "auto" === u ? Math.max(m.point.x, k) + f + d : k + f + d,
                                B = n + h > m.point.x)) : (n = m.point.x + f + d,
                            n > g - h - f - d && (n = "auto" === u ? Math.min(m.point.x, g) - h - f - d : g - h - f - d,
                                B = n < m.point.x))) : (k = Math.max(m.bounds.x1, b.x1),
                            Math.min(m.bounds.x2, b.x2),
                            d = 0 <= p.indexOf("range") ? 0 > x ? Math.max(m.bounds.x1, b.x1) + h / 2 + f : Math.min(m.bounds.x2, b.x2) - h / 2 - f : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2,
                            n = 0 > x ? Math.max(m.point.x, d) - h / 2 : Math.min(m.point.x, d) - h / 2,
                            n = Math.max(n, k));
                "vertical" === v && (e += l);
                q.x = n;
                q.y = e;
                q.render(!0);
                w && ("inside" !== u && (0 > p.indexOf("bar") && m.point.x > b.x1 && m.point.x < b.x2 || !B) && (0 > p.indexOf("column") && m.point.y > b.y1 && m.point.y < b.y2 || !B)) && (c.lineWidth = w,
                    c.strokeStyle = s ? s : "gray",
                c.setLineDash && c.setLineDash(G(r, w)),
                    c.beginPath(),
                    c.moveTo(m.point.x, m.point.y),
                    0 <= p.indexOf("bar") ? c.lineTo(n + (0 < m.direction ? 0 : h), e + ("horizontal" === v ? l : -l) / 2) : 0 <= p.indexOf("column") ? c.lineTo(n + h / 2, e + ((0 < m.direction ? l : -l) + ("horizontal" === v ? l : -l)) / 2) : c.lineTo(n + h / 2, e + ((e < m.point.y ? l : -l) + ("horizontal" === v ? l : -l)) / 2),
                    c.stroke())
            }
        }
        c = {
        ...
        for (a = 0; a < this._indexLabels.length; a++)
            m = this._indexLabels[a],
                q = K("indexLabelBackgroundColor", m.dataPoint, m.dataSeries),
                m.dataSeries.indexLabelBackgroundColor = y(q) ? t ? "transparent" : null : q;
        return c
    }
    ;
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    for (var v = !1, s = 0; s < l.length; s++)
                        if (w = l[s].x.getTime ? l[s].x.getTime() : l[s].x,
                                !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !v)))
                            if ("number" !== typeof l[s].y)
                                0 < s && !(h.connectNullData || v || r) && (c.stroke(),
                                t && b.stroke()),
                                    v = !0;
                            else {
                                ...
                                r || v ? (!r && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || m === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(f.x, f.y),
                                    m = h.nullDataLineDashType,
                                    c.setLineDash(p)),
                                    c.lineTo(w, u),
                                t && b.lineTo(w, u)) : (c.beginPath(),
                                    c.moveTo(w, u),
                                t && (b.beginPath(),
                                    b.moveTo(w, u))),
                                    v = r = !1) : (c.lineTo(w, u),
                                ...
                                s < l.length - 1 && (q !== (l[s].lineColor || e) || m !== (l[s].lineDashType || h.lineDashType)) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(w, u),
                                    q = l[s].lineColor || e,
                                    c.strokeStyle = q,
                                c.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType,
                                    c.setLineDash(G(m, h.lineThickness))) : (m = h.lineDashType,
                                    c.setLineDash(n))));
    ...
    B.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    for (var v = !1, s = 0; s < l.length; s++)
                        if (w = l[s].getTime ? l[s].x.getTime() : l[s].x,
                                !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !v)))
                            if ("number" !== typeof l[s].y)
                                0 < s && !(h.connectNullData || v || r) && (c.stroke(),
                                t && b.stroke()),
                                ...
                                c.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType,
                                    ...
                                    c.setLineDash(n))));
                                if (0 < l[s].markerSize || 0 < h.markerSize)
                                    z = h.getMarkerProperties(s, w, u, c),
                                        d.push(z),
                                        x = F(x),
                                    t && d.push({
                                        x: w,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length)
                    for (w = !1,
                             r = 0; r < l.length; r++)
                        if (s = l[r].getTime ? l[r].x.getTime() : l[r].x,
                                !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !w)))
                            if ("number" !== typeof l[r].y)
                                0 < r && !w && (h.connectNullData ? b.setLineDash && (0 < u.length && (h.options.nullDataLineDashType || !l[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = p,
                                        m = h.nullDataLineDashType) : (c(u),
                                    u = [])),
                                    w = !0;
                            else {
                                ...
                                r < l.length - 1 && (q !== (l[r].lineColor || e) || m !== (l[r].lineDashType || h.lineDashType)) && (q = l[r].lineColor || e,
                                    u[u.length - 1].newStrokeStyle = q,
                                b.setLineDash && (l[r].lineDashType ? (m = l[r].lineDashType,
                                    u[u.length - 1].newLineDashArray = G(m, h.lineThickness)) : (m = h.lineDashType,
    ...
    var M = function(a, c, b, d, f, g, k, h, l, m, p, n, e) {
        ...
        !0 === l && (a.save(),
            ...
            a.lineTo(d, b),
            a.closePath(),
            k = a.createLinearGradient((d + c) / 2, b + q, (d + c) / 2, b),
            k.addColorStop(0, g),
        ...
        !0 === m && (a.save(),
            ...
            a.lineTo(d, f),
            a.closePath(),
            k = a.createLinearGradient((d + c) / 2, f - q, (d + c) / 2, f),
            k.addColorStop(0, g),
            k.addColorStop(1, "rgba(255, 255, 255, .4)"),
            a.fillStyle = k,
            a.fill(),
        ...
        !0 === p && (a.save(),
            ...
            a.lineTo(c, f),
            a.closePath(),
            k = a.createLinearGradient(c + q, (f + b) / 2, c, (f + b) / 2),
            k.addColorStop(0, g),
        ...
        !0 === n && (a.save(),
            ...
            a.lineTo(d - q, f - q),
            a.lineTo(d, f),
            k = a.createLinearGradient(d - q, (f + b) / 2, d, (f + b) / 2),
            k.addColorStop(0, g),
            k.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
            a.fillStyle = k,
            k.addColorStop(0, g),
    ...
    B.prototype.renderColumn = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = 0, g, k, h, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
    ...
    B.prototype.renderStackedColumn = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = [], g = [], k = [], h = 0, l, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, p = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, n = a.axisX.dataInfo.minDiff;
                ...
                if (0 < r.length) {
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x,
                            ...
                            var d = a.axisX.convertValueToPixel(b), w = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, u = w + n << 0, v;
                            if (a.axisY.logarithmic)
                                k[b] = r[h].y + (k[b] ? k[b] : 0),
                                0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]),
                                    v = f[b] ? f[b] : m,
                                    f[b] = l);
                            else if (l = a.axisY.convertValueToPixel(r[h].y),
                                0 <= r[h].y) {
                                var z = f[b] ? f[b] : 0;
                                l -= z;
                                v = m - z;
    ...
    B.prototype.renderBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = 0, g, k, h, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
    ...
    B.prototype.renderStackedBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = [], g = [], k = [], h = 0, l, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, p = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x,
                            ...
                            if (a.axisY.logarithmic) {
                                ...
                                w = f[b] ? f[b] : m;
                                f[b] = l = a.axisY.convertValueToPixel(k[b])
                            } else if (l = a.axisY.convertValueToPixel(w),
                                0 <= r[h].y) {
                                var z = f[b] ? f[b] : 0;
                                w = m + z;
                                l += z;
    ...
    B.prototype.renderArea = function(a) {
        var c, b;
        function d() {
            x && (0 < e.lineThickness && f.stroke(),
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = v : 0 > a.axisY.viewportMaximum ? z = h.y1 : 0 < a.axisY.viewportMinimum && (z = k.y2),
                f.lineTo(s, z),
                f.lineTo(x.x, z),
                f.closePath(),
                f.globalAlpha = e.fillOpacity,
                f.fill(),
                f.globalAlpha = 1,
            t && (g.lineTo(s, z),
                g.lineTo(x.x, z),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var g = this._eventManager.ghostCtx, k = a.axisX.lineCoordinates, h = a.axisY.lineCoordinates, l = [], m = this.plotArea, p;
            f.save();
            t && g.save();
            f.beginPath();
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                l = [];
                c = !0;
                var r = 0, s, w, u, v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, x = null;
                if (0 < q.length) {
                    ...
                    for (var W = !0; r < q.length; r++)
                        if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x,
                                !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !W)))
                            if ("number" !== typeof q[r].y)
                                e.connectNullData || (W || c) || d(),
                                    W = !0;
                            else {
                                s = a.axisX.convertValueToPixel(u);
                                w = a.axisY.convertValueToPixel(q[r].y);
                                c || W ? (!c && e.connectNullData ? (f.setLineDash && (e.options.nullDataLineDashType || b === e.lineDashType && e.lineDashType !== e.nullDataLineDashType) && (c = s,
                                    b = w,
                                    s = p.x,
                                    w = p.y,
                                    d(),
                                    ...
                                    w = b,
                                    x = p,
                                    b = e.nullDataLineDashType,
                                    f.setLineDash(C)),
                                    f.lineTo(s, w),
                                t && g.lineTo(s, w)) : (f.beginPath(),
                                    f.moveTo(s, w),
                                t && (g.beginPath(),
                                    g.moveTo(s, w)),
                                    x = {
                                ...
                                r < q.length - 1 && (B !== (q[r].lineColor || A) || b !== (q[r].lineDashType || e.lineDashType)) && (d(),
                                    B = q[r].lineColor || A,
                                    f.strokeStyle = B,
                                f.setLineDash && (q[r].lineDashType ? (b = q[r].lineDashType,
                                    f.setLineDash(G(b, e.lineThickness))) : (b = e.lineDashType,
                                    f.setLineDash(V))));
                                ...
                                0 !== q[r].markerSize && (0 < q[r].markerSize || 0 < e.markerSize) && (u = e.getMarkerProperties(r, s, w, f),
                                    l.push(u),
                                    I = F(I),
                                t && l.push({
                                    x: s,
    ...
    B.prototype.renderSplineArea = function(a) {
                ...
                if (0 < m.lineThickness) {
                    ...
                    for (var e = 0; e < c.length - 3; e += 3)
                        if (b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y),
                            t && d.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                k = F(k);
                d.fillStyle = k;
                var k = [], n = 0, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s, w = null, u = [];
                if (0 < p.length) {
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x,
                                !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
                            if ("number" !== typeof p[n].y)
                                0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A,
                                        y = m.nullDataLineDashType) : (c(),
                                    u = [])),
                                    q = !0;
                            else {
                                ...
                                n < p.length - 1 && (x !== (p[n].lineColor || z) || y !== (p[n].lineDashType || m.lineDashType)) && (x = p[n].lineColor || z,
                                    u[u.length - 1].newStrokeStyle = x,
                                b.setLineDash && (p[n].lineDashType ? (y = p[n].lineDashType,
                                    u[u.length - 1].newLineDashArray = G(y, m.lineThickness)) : (y = m.lineDashType,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (; r < q.length; r++)
                        if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x,
                                !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !b))) {
                            var I = w;
                            "number" !== typeof q[r].y ? (e.connectNullData || (b || c) || d(),
                                b = !0) : (s = a.axisX.convertValueToPixel(u),
                                w = a.axisY.convertValueToPixel(q[r].y),
                                c || b ? (!c && e.connectNullData ? (f.setLineDash && (e.options.nullDataLineDashType || C === e.lineDashType && e.lineDashType !== e.nullDataLineDashType) && (c = s,
                                    b = w,
                                    s = p.x,
                                    w = p.y,
                                    d(),
                            ...
                            r < q.length - 1 && (B !== (q[r].lineColor || A) || C !== (q[r].lineDashType || e.lineDashType)) && (d(),
                                B = q[r].lineColor || A,
                                f.strokeStyle = B,
                            f.setLineDash && (q[r].lineDashType ? (C = q[r].lineDashType,
                                f.setLineDash(G(C, e.lineThickness))) : (C = e.lineDashType,
                                f.setLineDash(W)))),
                                u = e.dataPointIds[r],
                            ...
                            0 !== q[r].markerSize && (0 < q[r].markerSize || 0 < e.markerSize) && (I = e.getMarkerProperties(r, s, w, f),
                                l.push(I),
                                u = F(u),
                            t && l.push({
                                x: s,
    ...
    B.prototype.renderStackedArea = function(a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, f = [], g = this.plotArea, k = [], h = [], l = [], m = [], p = 0, n, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, w, u, v;
            t && s.beginPath();
            b.save();
            t && s.save();
            b.beginPath();
            ...
            b.clip();
            t && (s.beginPath(),
                s.rect(g.x1, g.y1, g.width, g.height),
                s.clip());
            d = [];
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                for (p = 0; p < y.length; p++)
                    z = y[p].x.getTime ? y[p].x.getTime() : y[p].x,
                        x.dataPointIndexes[z] = p,
                    d[z] || (l.push(z),
                        d[z] = !0);
                l.sort(ya)
            }
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!x.connectNullData || !W)))
                            if ("number" !== typeof I.y)
                                ...
                                if (a.axisY.logarithmic) {
                                    ...
                                    e = a.axisY.convertValueToPixel(I.y),
                                        e -= da;
                                h.push({
                                    x: n,
                                    y: r - da
                                ...
                                k[q] = r - e;
                                u || W ? (!u && x.connectNullData ? (b.setLineDash && (x.options.nullDataLineDashType || v === x.lineDashType && x.lineDashType !== x.nullDataLineDashType) && (u = h.pop(),
                                    v = h[h.length - 1],
                                    c(),
                                    b.moveTo(w.x, w.y),
                                    h.push(v),
                                ...
                                p < y.length - 1 && (B !== (y[p].lineColor || A) || v !== (y[p].lineDashType || x.lineDashType)) && (c(),
                                    b.beginPath(),
                                    b.moveTo(n, e),
                                    h.push({
                                        x: n,
                                    ...
                                    B = y[p].lineColor || A,
                                    b.strokeStyle = B,
                                b.setLineDash && (y[p].lineDashType ? (v = y[p].lineDashType,
                                    b.setLineDash(G(v, x.lineThickness))) : (v = x.lineDashType,
                                    b.setLineDash(V))));
                                ...
                                0 <= x.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < x.markerSize) && (q = x.getMarkerProperties(x.dataPointIndexes[q], n, e, b),
                                    f.push(q),
                                    markerColor = F(ea),
                                t && f.push({
                                    x: n,
    ...
    B.prototype.renderStackedArea100 = function(a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, f = this.plotArea, g = [], k = [], h = [], l = [], m = [], p = 0, n, e, q, r, s, w, u = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
            b.save();
            t && v.save();
            b.beginPath();
            b.rect(f.x1, f.y1, f.width, f.height);
            b.clip();
            t && (v.beginPath(),
                v.rect(f.x1, f.y1, f.width, f.height),
                v.clip());
            d = [];
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!x.connectNullData || !W)))
                            if ("number" !== typeof I.y)
                                ...
                                if (a.axisY.logarithmic) {
                                    ...
                                    e = a.axisY.convertValueToPixel(da),
                                        e -= ea;
                                h.push({
                                    x: n,
                                    y: u - ea
                                ...
                                k[q] = u - e;
                                s || W ? (!s && x.connectNullData ? (b.setLineDash && (x.options.nullDataLineDashType || w === x.lineDashType && x.lineDashType !== x.nullDataLineDashType) && (s = h.pop(),
                                    w = h[h.length - 1],
                                    c(),
                                    b.moveTo(r.x, r.y),
                                    h.push(w),
                                    h.push(s),
                                    w = x.nullDataLineDashType,
                                    b.setLineDash(C)),
                                    b.lineTo(n, e),
                                t && v.lineTo(n, e)) : (b.beginPath(),
                                    b.moveTo(n, e),
                                t && (v.beginPath(),
                                    v.moveTo(n, e))),
                                    W = s = !1) : (b.lineTo(n, e),
                                ...
                                p < y.length - 1 && (B !== (y[p].lineColor || A) || w !== (y[p].lineDashType || x.lineDashType)) && (c(),
                                    b.beginPath(),
                                    b.moveTo(n, e),
                                    h.push({
                                        x: n,
                                    ...
                                    B = y[p].lineColor || A,
                                    b.strokeStyle = B,
                                b.setLineDash && (y[p].lineDashType ? (w = y[p].lineDashType,
                                    b.setLineDash(G(w, x.lineThickness))) : (w = x.lineDashType,
                                    b.setLineDash(V))));
                                if (0 <= x.dataPointIndexes[q]) {
                                ...
                                0 <= x.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < x.markerSize) && (q = x.getMarkerProperties(p, n, e, b),
                                    g.push(q),
                                    markerColor = F(Fa),
                                t && g.push({
                                    x: n,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = -Infinity, h = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, e = 0, d = 0; d < n.length; d++)
                    f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x,
                    f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[d].z || (e = n[d].z,
                    e > k && (k = e),
                    e < h && (h = e));
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var p = 0, n = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x,
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            f = a.axisX.convertValueToPixel(f);
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((p - f) * (p - f) + (n - g) * (n - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = l.dataPointIds[d],
                                this._eventManager.objectMap[p] = {
                                    id: p,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: h,
                                ...
                                p = F(p),
                            t && N.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, p, p, e.borderThickness),
                            (m[d].indexLabel || l.indexLabel || m[d].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[d],
                                dataSeries: l,
                                point: {
    ...
    B.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, f = 0, g, k, h, l, m, p, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)
                    for (var w = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x,
                            !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            "candlestick" === r.type ? (c.moveTo(g - x, h),
                                c.lineTo(g - x, Math.min(k, m)),
                                c.stroke(),
                                c.moveTo(g - x, Math.max(k, m)),
                                c.lineTo(g - x, l),
                                c.stroke(),
                                M(c, u, Math.min(k, m), v, Math.max(k, m), s[f].y[0] <= s[f].y[3] ? r.risingColor : d, z, d, w, w, !1, !1, r.fillOpacity),
                            t && (d = F(y),
                                b.strokeStyle = d,
                                b.moveTo(g - x, h),
                                b.lineTo(g - x, Math.min(k, m)),
                                b.stroke(),
                                b.moveTo(g - x, Math.max(k, m)),
                                b.lineTo(g - x, l),
                                b.stroke(),
                                M(b, u, Math.min(k, m), v, Math.max(k, m), d, 0, null, !1, !1, !1, !1))) : "ohlc" === r.type && (c.moveTo(g - x, h),
                                    c.lineTo(g - x, l),
                                    c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(g, k),
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < n.length)
                    for (var e = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)
                        if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x,
                            !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
    ...
    B.prototype.renderRangeArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            t && (d.beginPath(),
                d.rect(g.x1, g.y1, g.width, g.height),
                d.clip());
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                var k = []
                ...
                if (0 < m.length) {
                    ...
                    for (var B = !0; n < m.length; n++)
                        if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x,
                                !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !B)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                p || B ? (l.connectNullData && !p ? (b.setLineDash && (l.options.nullDataLineDashType || x === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = A,
                                    x = l.nullDataLineDashType,
                                    b.setLineDash(y)),
                                    b.lineTo(e, q),
                                t && d.lineTo(e, q),
                                    k.push({
                                ...
                                n < m.length - 1 && (z !== (m[n].lineColor || v) || x !== (m[n].lineDashType || l.lineDashType)) && (c(),
                                    z = m[n].lineColor || v,
                                    k[k.length - 1].newStrokeStyle = z,
                                    b.strokeStyle = z,
                                b.setLineDash && (m[n].lineDashType ? (x = m[n].lineDashType,
                                    k[k.length - 1].newLineDashArray = G(x, l.lineThickness),
                                    b.setLineDash(k[k.length - 1].newLineDashArray)) : (x = l.lineDashType,
                                    k[k.length - 1].newLineDashArray = A,
                                    b.setLineDash(A))));
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    ...
                    for (n = !1; m < l.length; m++)
                        if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x,
                                !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !n)))
                            if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] && "number" === typeof l[m].y[1]) {
                                ...
                                m < l.length - 1 && (u !== (l[m].lineColor || w) || v !== (l[m].lineDashType || h.lineDashType)) && (u = l[m].lineColor || w,
                                    q[q.length - 1].newStrokeStyle = u,
                                b.setLineDash && (l[m].lineDashType ? (v = l[m].lineDashType,
                                    q[q.length - 1].newLineDashArray = G(v, h.lineThickness)) : (v = h.lineDashType,
                                ...
                                if (l[m].indexLabel || h.indexLabel || l[m].indexLabelFormatter || h.indexLabelFormatter)
                                    this._indexLabels.push({
                                ...
                                0 < m && !n && (h.connectNullData ? b.setLineDash && (0 < q.length && (h.options.nullDataLineDashType || !l[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = x,
                                        v = h.nullDataLineDashType) : (c(z, w),
                                    q = [],
                                    r = [])),
                                    n = !0;
                    c(z, w);
    ...
    B.prototype.renderPie = function(a) {
            ...
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    if (k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u) {
                        if (0 === a || q[c].midAngle > k.midAngle)
                            c = f;
                        a++
                    } else if (k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u) {
                        if (0 === b || q[d].midAngle > k.midAngle)
                            d = f;
                        b++
                    }
                ...
                for (f = 0; f < p.length; f++)
                    k = q[(c + f) % p.length],
                    1 < a && (k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u) && (g <= a / 2 && !n ? (k.hemisphere = "right",
                        g++) : (k.hemisphere = "left",
                        n = !0));
                n = !1;
                for (f = 0; f < p.length; f++)
                    k = q[(d + f) % p.length],
                    1 < b && (k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u) && (h <= b / 2 && !n ? (k.hemisphere = "left",
                        h++) : (k.hemisphere = "right",
                        n = !0))
            }
        }
        function b(a) {
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * C * Math.cos(q[b].midAngle)
                        ...
                        , k = !1;
                    if (p[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (z.x + f)) || 1E-9 < Math.abs(q[b].center.y - (z.y + g)))
                            q[b].center.x = z.x + f * a,
                                q[b].center.y = z.y + g * a,
                                k = !0
                    } else if (0 < Math.abs(q[b].center.x - z.x) || 0 < Math.abs(q[b].center.y - z.y))
                        q[b].center.x = z.x + f * (1 - a),
                            q[b].center.y = z.y + g * (1 - a),
                            k = !0;
                    k && (f = {},
                        f.dataSeries = m,
                        f.dataPoint = m.dataPoints[b],
                        f.index = b,
            ...
            for (b = b = 0; b < p.length; b++)
                ...
                c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2,
                    d = 0,
                    d = "left" === c.hemisphere ? "inside" !== m.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== m.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2,
                ...
                "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + C * Math.cos(c.midAngle),
                    f = c.center.y + C * Math.sin(c.midAngle),
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                m = f(a);
                h = k = 0;
                0 > b ? (h = "right" === l.hemisphere ? n : m,
                    e = b,
                null !== h && (n = -b,
                    b = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - (q[h].indexLabelTextBlock.y + q[h].indexLabelTextBlock.height / 2),
                b - n < r && (k = -n,
                    h = g(h, k, c + 1),
                +h.toFixed(v) > +k.toFixed(v) && (e = b > r ? -(b - r) : -(n - (h - k)))))) : 0 < b && (h = "right" === l.hemisphere ? m : n,
                        e = b,
                    null !== h && (n = b,
                        b = q[h].indexLabelTextBlock.y - q[h].indexLabelTextBlock.height / 2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2),
                    b - n < r && (k = n,
                        h = g(h, k, c + 1),
                    +h.toFixed(v) < +k.toFixed(v) && (e = b > r ? b - r : n - (k - h)))));
                e && (c = l.indexLabelTextBlock.y + e,
                    b = 0,
                    b = "right" === l.hemisphere ? z.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - z.y, 2)) : z.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - z.y, 2)),
                    l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u ? (k = (a - 1 + q.length) % q.length,
                        k = q[k],
                        a = q[(a + 1 + q.length) % q.length],
                        "left" === l.hemisphere && "right" === k.hemisphere && b > k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x - 15 : "right" === l.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : l.midAngle > 3 * Math.PI / 2 - u && l.midAngle < 3 * Math.PI / 2 + u && (k = (a - 1 + q.length) % q.length,
                            k = q[k],
                            a = q[(a + 1 + q.length) % q.length],
                    ...
                    l.indexLabelTextBlock.y = c,
                    l.indexLabelTextBlock.x = b,
                    l.indexLabelAngle = Math.atan2(l.indexLabelTextBlock.y - z.y, l.indexLabelTextBlock.x - z.x))
            }
            return e
        }
        function k() {
            ...
            for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                if (m.radius || !m.radius && "undefined" !== typeof m.innerRadius && null !== m.innerRadius && C - c <= E)
                    k = !1;
                k && (C -= c);
                c = 0;
                if ("inside" !== m.indexLabelPlacement) {
                    ...
                    for (var u, t, a = 0; a < p.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var y = 0
                                , y = d(u, t) - r;
                            if (0 > y) {
                                for (var A = t = 0, B = 0; B < p.length; B++)
                                    B !== a && q[B].hemisphere === h.hemisphere && (q[B].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? t++ : A++);
                                t = y / (t + A || 1) * A;
                                var A = -1 * (y - t)
                                    , D = B = 0;
                                "right" === h.hemisphere ? (B = g(a, t),
                                    A = -1 * (y - B),
                                    D = g(x, A),
                                +D.toFixed(v) < +A.toFixed(v) && +B.toFixed(v) <= +t.toFixed(v) && g(a, -(A - D))) : (B = g(x, t),
                                    A = -1 * (y - B),
                                    D = g(a, A),
                                +D.toFixed(v) < +A.toFixed(v) && +B.toFixed(v) <= +t.toFixed(v) && g(x, -(A - D)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < p.length; a++)
                        h = q[a],
                            s = "pie" === m.type ? 0.7 * C : 0.8 * C,
                            x = z.x + s * Math.cos(h.midAngle),
                            t = z.y + s * Math.sin(h.midAngle),
                ...
                for (a = 0; a < p.length; a++)
                    if (h = q[a],
                        ...
                        x = x = 0,
                            "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + n),
                                x *= -1) : x = e.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - n),
                        0 < x && (!k && h.indexLabelText && (t = "right" === h.hemisphere ? e.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - e.x1,
                        ...
                        Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < C || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) < C) && (x /= Math.abs(Math.cos(h.indexLabelAngle)),
                        9 < x && (x *= 0.3),
                        x > c && (c = x)),
                            x = x = 0,
                            0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (x = e.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                                x *= -1) : x = e.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                        0 < x && (!k && h.indexLabelText && (t = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                        0 === g(a, x * t) && g(a, 2 * t)),
                        Math.abs(h.indexLabelTextBlock.x - z.x) < C && (x /= Math.abs(Math.sin(h.indexLabelAngle)),
                        9 < x && (x *= 0.3),
                        x > c && (c = x)));
                    ...
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < p.length; g++)
                        if (e = !1,
                            ...
                            if (null !== h) {
                                ...
                                h !== a && (b = h,
                                    c += -y),
                                0 === g % Math.max(p.length / 10, 3) && (e = !0)) : e = !0;
                                e && (0 < c && 0 <= a && 0 <= b) && (G(c, a, b),
                                    b = a = -1,
                                    c = 0)
                            }
                        }
        ...
        var l = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]], p = m.dataPoints, n = 10, e = this.plotArea, q = [], r = 2, s, w = 1.3, u = 20 / 180 * Math.PI, v = 6, z = {
                x: (e.x2 + e.x1) / 2,
                y: (e.y2 + e.y1) / 2
            }, t = 0;
            a = !1;
            ...
            if (0 !== t) {
                ...
                this.pieDoughnutClickHandler = function(a) {
                    l.isAnimating || !y(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
    ...
    B.prototype.set = function(a, c, b) {
        ...
        b && this.render()) : B.base.set.call(this, a, c, b)
    }
    ;
    ...
    ma.prototype.render = function() {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (d = c.y1 + 2,
                l = "top") : "bottom" === this.verticalAlign && (d = c.y2 - 2 - m.height,
                    l = "bottom"),
                "left" === this.horizontalAlign ? b = c.x1 + 2 : "center" === this.horizontalAlign ? b = c.x1 + c.width / 2 - m.width / 2 : "right" === this.horizontalAlign && (b = c.x2 - 2 - m.width - k),
                h = this.horizontalAlign,
                this.width = m.width,
                this.height = m.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (b = c.x1 + 2,
                    d = c.y2 - 2 - (this.maxWidth / 2 - m.width / 2),
                    f = -90,
                    l = "left",
                    this.width = m.height,
                    this.height = m.width) : "right" === this.horizontalAlign ? (b = c.x2 - 2,
                    d = c.y1 + 2 + (this.maxWidth / 2 - m.width / 2),
                    f = 90,
                    l = "right",
                    this.width = m.height,
                    this.height = m.width) : "center" === this.horizontalAlign && (d = a.y1 + (a.height / 2 - m.height / 2),
                        b = a.x1 + (a.width / 2 - m.width / 2),
                        l = "center",
                        this.width = m.width,
    ...
    wa.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart
            ...
            , g = 0
            , k = 0
            , h = this.markerMargin = this.chart.options.legend && !y(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var l = []
            , m = [];
            ...
            for (p = 0; p < l.length; p++) {
                ...
                if (!(0 >= k || "undefined" === typeof k || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!n || n.width + Math.round(e.textBlock.width + s + h + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g)
                            n = {
                                items: [],
                                width: 0
                            },
                        ...
                        e.textBlock = new U(this.ctx,{
                            ...
                            e.textBlock.measureText(),
                        null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + h + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                            this.height < k - this.lineHeight ? (n = {
                                items: [],
                                width: 0
                            },
                                m.push(n)) : (n = m[t],
                    ...
                    r = e.textBlock.width + (s + h + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            }
            this.itemWidth = r;
            ...
            for (t = v = 0; t < n.items.length; t++) {
                ...
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" === e.chartType)
                    this.ctx.strokeStyle = e.lineColor,
                        ...
                        this.ctx.beginPath(),
                        this.ctx.moveTo(r - 0.1 * this.lineHeight, w + this.lineHeight / 2),
                        this.ctx.lineTo(r + 0.85 * this.lineHeight, w + this.lineHeight / 2),
                        this.ctx.stroke(),
    ...
    $.prototype.getDataPointAtX = function(a, c) {
        ...
        "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (p = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            p = 1 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
            p = 0 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (; ; ) {
            g = 0 < k ? p + f : p - f;
            if (0 <= g && g < this.dataPoints.length) {
                var d = this.dataPoints[g]
                    , n = this.axisX.logarithmic ? d.x > a ? d.x / a : a / d.x : Math.abs(d.x - a);
                n < b.distance && (b.dataPoint = d,
                    b.distance = n,
                    b.index = g);
                d = n;
                d <= h ? h = d : 0 < k ? l++ : m++;
    ...
    $.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        "none" !== this.chart.plotInfo.axisPlacement && (n = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
            ...
            this.axisX.logarithmic ? (g = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                n = 1 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * Math.log(n / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (g = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
                n = 0 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (; ; ) {
            g = 0 < k ? n + f : n - f;
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "doughnut":
                            ...
                            r < e.radius && r > t && (r = Math.atan2(c - s.y, a - s.x),
                            0 > r && (r += 2 * Math.PI),
                                r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)),
                                s = Number(((180 * (e.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                                t = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            0 === t && 1 < e.endAngle && (t = 360),
                            s >= t && 0 !== q.y && (t += 360,
                            r < s && (r += 360)),
                            r > s && r < t && (d.push({
                                dataPoint: q,
    ...
    C.prototype.createExtraLabelsForLog = function(a) {
        ...
        if (!(5 < a)) {
            ...
            if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) {
                for (var b = C.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), d = Math.ceil(this.viewportMinimum / b) * b; d < c; d += b)
    ...
    C.prototype.createLabels = function() {
        var a, c, b = 0, d = 0, f, g = 0, k = 0, d = 0, h = this.interval, l = 0, m, p = 0.6 * this.chart.height, b = !1;
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval),
                     f = Ha(new Date(this.viewportMaximum), this.interval, this.intervalType),
                     b = this.intervalStartPosition; b < f; Ha(b, h, this.intervalType))
                a = b.getTime(),
                    ...
                    }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : Ea(b, this.valueFormatString, this.chart._cultureInfo),
                    a = new U(this.ctx,{
                        x: 0,
                        y: 0,
                        maxWidth: g,
            ...
            if (this.logarithmic && !this.equidistantInterval) {
                ...
                for (var e = 0; e < this.logLabelValues.length; e++)
                    ...
                    b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
                        ...
                        value: b,
                        label: this.labels[b] ? this.labels[b] : null
                    }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ca(b, this.valueFormatString, this.chart._cultureInfo),
                        a = new U(this.ctx,{
                            x: 0,
                            y: 0,
                            maxWidth: g,
        ...
        if ("bottom" === this._position || "top" === this._position)
            l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * H[this.intervalType + "Duration"] * this.interval,
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock,
                            ...
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d),
                                    s = (p - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                    !y(this.options.labelWrap))
                                this.labelWrap ? y(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), s),
                                    this.sessionVariables.labelWrap = this.labelWrap,
                                q.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                    ...
                                    this.sessionVariables.labelMaxHeight = k,
                                    this.sessionVariables.labelMaxWidth = g,
                                q.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25,
                                    ...
                                    if (!y(this.options.labelMaxWidth))
                                        ...
                                        if (d = q.width + c.width >> 0,
                                            ...
                                            d - 2 * g > h && (h = d - 2 * g,
                                                ...
                                                y(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? e : this.options.labelFontSize,
                                                    ...
                                                    this.sessionVariables.labelFontSize = e) : d >= 2.8 * g && d < 3.2 * g ? (this.sessionVariables.labelMaxWidth = Math.max(g, n),
                                                ...
                                                y(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                    ...
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = s,
                                                    this.sessionVariables.labelFontSize = this.labelFontSize) : d > 3.6 * g && d < 5 * g ? (y(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? e : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    ...
                                                    this.sessionVariables.labelMaxWidth = s) : d > 5 * g && (this.sessionVariables.labelWrap = !0,
                                                        ...
                                                        this.sessionVariables.labelMaxHeight = k,
                                                        this.sessionVariables.labelAngle = this.labelAngle));
                                        else if (r === b && (0 === r && n + this._labels[r + 1].textBlock.measureText().width - 2 * g > h || r === this._labels.length - 1 && n + this._labels[r - 1].textBlock.measureText().width - 2 * g > h || 0 < r && r < this._labels.length - 1 && n + this._labels[r + 1].textBlock.measureText().width - 2 * g > h && n + this._labels[r - 1].textBlock.measureText().width - 2 * g > h))
                                            h = 0 === r ? n + this._labels[r + 1].textBlock.measureText().width - 2 * g : n + this._labels[r - 1].textBlock.measureText().width - 2 * g,
                                                this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? e : this.options.labelFontSize,
                                                this.sessionVariables.labelWrap = !0,
                                                this.sessionVariables.labelAngle = -25,
                                                this.sessionVariables.labelMaxWidth = s;
                                        else if (0 === h)
                                            for (this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? e : this.options.labelFontSize,
                                                     this.sessionVariables.labelWrap = !0,
                                                     d = 0; d < this._labels.length; d++)
                                                a = this._labels[d].textBlock,
                                                    a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), s),
                                                    q = a.measureText(),
                                                d < this._labels.length - 1 && (e = d + 1,
                                                    c = this._labels[e].textBlock,
                                                    c.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), s),
                                                    c = c.measureText(),
                                                q.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25))
                            }
                        else
                            (this.sessionVariables.labelAngle = this.labelAngle,
                                ...
                                s = 0 != this.labelAngle ? (p - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : g,
                                this.sessionVariables.labelMaxHeight = k = this.labelWrap ? (p - s * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                                ...
                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : s) : (y(this.options.labelMaxWidth),
                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : s,
                                this.sessionVariables.labelWrap = this.labelWrap),
                                this.sessionVariables.labelMaxHeight = k);
                    for (d = 0; d < this._labels.length; d++)
                ...
                if (g = y(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        ...
                        b < this._labels.length - 1 && (e = b + 1,
                            ...
                            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                            Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                        y(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) ? y(this.options.labelWrap) ? y(this.options.labelWrap) && (y(this.options.labelMaxWidth) ? y(c) || (l = q.height + c.height >> 0,
                                l - 2 * k > n && (n = l - 2 * k,
                                    l >= 2 * k && l < 2.4 * k ? (y(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                        a.measureText()),
                                        this.sessionVariables.labelMaxHeight = k,
                                        this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * k && l < 2.8 * k ? (this.sessionVariables.labelMaxHeight = d,
                                        this.sessionVariables.labelFontSize = this.labelFontSize,
                                    ...
                                    y(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                        ...
                                        this.sessionVariables.labelAngle = y(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l >= 3.2 * k && l < 3.6 * k ? (this.sessionVariables.labelMaxHeight = d,
                                        this.sessionVariables.labelWrap = !0,
                                        this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * k && l < 10 * k ? (y(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                        a.measureText()),
                                        this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                        this.sessionVariables.labelMaxWidth = g,
                                        this.sessionVariables.labelMaxHeight = k,
                                        this.sessionVariables.labelAngle = y(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l > 10 * k && l < 50 * k && (y(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                            a.measureText()),
                                            this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                            this.sessionVariables.labelMaxHeight = k,
                                            this.sessionVariables.labelMaxWidth = g,
                                            this.sessionVariables.labelAngle = y(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = k,
                            ...
                            y(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : d,
                            this.sessionVariables.labelWrap = this.labelWrap,
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === g.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    w = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                if ("left" === this._position || "right" === this._position)
                    w = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                ...
                k = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
                    w = "undefined" === typeof g.options.labelWrap || g.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    c = y(g.options.labelBackgroundColor) ? y(g.startValue) && 0 !== g.startValue ? t ? "transparent" : null : "#EEEEEE" : g.options.labelBackgroundColor;
            a = new U(this.ctx,{
                x: 0,
                y: 0,
                backgroundColor: c,
    ...
    C.setLayoutAndRender = function(a, c, b, d, f, g) {
        ...
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e] && a[e].title && (a[e]._titleTextBlock = new U(a[e].ctx,{
                    text: a[e].title,
                    horizontalAlign: "center",
        ...
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e] && c[e].title && (c[e]._titleTextBlock = new U(c[e].ctx,{
                    text: c[e].title,
                    horizontalAlign: "center",
        ...
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e] && b[e].title && (b[e]._titleTextBlock = new U(b[e].ctx,{
                    text: b[e].title,
                    horizontalAlign: "center",
        ...
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e] && d[e].title && (d[e]._titleTextBlock = new U(d[e].ctx,{
                    text: d[e].title,
                    horizontalAlign: "center",
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q; ) {
                ...
                if (d && 0 < d.length)
                    for (z = [],
                             e = R = 0; e < d.length; e++)
                        z.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)),
                            R += z[e],
                            Q += d[e] ? d[e].margin : 0;
                else
                ...
                if (a && 0 < a.length)
                    for (t = [],
                        ...
                        a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                            t.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)),
                            X += t[e],
                            f += a[e] ? a[e].margin : 0;
                else
                    t.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                I.push(t);
                if (c && 0 < c.length)
                    for (u = [],
                             e = T = 0; e < c.length; e++)
                        ...
                        c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width),
                            u.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)),
                            T += u[e],
                            K += c[e] ? c[e].margin : 0;
                else
                    u.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                H.push(u);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++)
                        a[e] && (a[e].lineCoordinates.x1 = k,
                            l = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q),
                        a[e]._labels && 1 < a[e]._labels.length && (h = m = 0,
                            m = a[e]._labels[1],
                            h = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1],
                            r = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                        ...
                        a[e] && (a[e].labelAutoFit && !y(x) && !y(A)) && (h = 0,
                            0 < a[e].labelAngle ? A + s > l && (h += 0 < a[e].labelAngle ? A + s - l - R : 0) : 0 > a[e].labelAngle ? x - r < k && x - r < a[e].viewportMinimum && (B = k - (D + a[e].tickLength + v + x - r + a[e].labelFontSize / 2)) : 0 === a[e].labelAngle && (A + s > l && (h = A + s / 2 - l - R),
                                x - r < k && x - r < a[e].viewportMinimum && (B = k - D - a[e].tickLength - v - x + r / 2)),
                            a[e].viewportMaximum === a[e].maximum && a[e].viewportMinimum === a[e].minimum && 0 < a[e].labelAngle && 0 < h ? l -= h : a[e].viewportMaximum === a[e].maximum && a[e].viewportMinimum === a[e].minimum && 0 > a[e].labelAngle && 0 < B ? k += B : a[e].viewportMaximum === a[e].maximum && a[e].viewportMinimum === a[e].minimum && 0 === a[e].labelAngle && (0 < B && (k += B),
                                0 < h && (l -= h))),
                            p.panEnabled ? X = p.sessionVariables.axisX.height : p.sessionVariables.axisX.height = X,
                            h = Math.round(g.y2 - X - f + M),
                            m = Math.round(g.y2),
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++)
                        c[e].lineCoordinates.x1 = Math.round(g.x1 + S + D),
                            c[e].lineCoordinates.x2 = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q),
                            c[e].lineCoordinates.width = Math.abs(l - k),
                        c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1],
                            h = "dateTime" === c[e].chart.plotInfo.axisXValueType ? c[e]._labels[c[e]._labels.length - 2] : c[e]._labels[c[e]._labels.length - 1],
                            r = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                            s = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))),
                            p.panEnabled ? T = p.sessionVariables.axisX2.height : p.sessionVariables.axisX2.height = T,
                            h = Math.round(g.y1),
                            m = Math.round(g.y2 + c[e].margin),
                            c[e].lineCoordinates.y1 = h + T + K - P,
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        ...
                        b[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                            D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10,
                            h = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K),
                            l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                            D = 0 < a.length ? 0 : b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[0].textBlock.height / 2 : 10,
                            m = Math.round(g.y2 - X - f - D),
                            b[e].lineCoordinates = {
                                x1: l - N,
                                y1: h,
                                x2: l - N,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++)
                        d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2),
                            l = Math.round(k),
                            D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0,
                            h = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K),
                            D = 0 < a.length ? 0 : d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[0].textBlock.height / 2 : 0,
                            m = Math.round(g.y2 - (X + f + D)),
                            d[e].lineCoordinates = {
                                x1: k + O,
                                y1: h,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++)
                        ...
                        a[e]._labels && 1 < a[e]._labels.length && (x = (a[e].logarithmic ? Math.log(a[e]._labels[1].position / a[e].viewportMinimum) / a[e].conversionParameters.lnLogarithmBase : a[e]._labels[1].position - a[e].viewportMinimum) * Math.abs(a[e].conversionParameters.pixelPerUnit) + a[e].lineCoordinates.x1,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++)
                        ...
                        c[e]._labels && 1 < c[e]._labels.length && (x = (c[e].logarithmic ? Math.log(c[e]._labels[1].position / c[e].viewportMinimum) / c[e].conversionParameters.lnLogarithmBase : c[e]._labels[1].position - c[e].viewportMinimum) * Math.abs(c[e].conversionParameters.pixelPerUnit) + c[e].lineCoordinates.x1,
            ...
            for (; 4 > q; ) {
                ...
                if (a && 0 < a.length)
                    for (B = [],
                             e = X = 0; e < a.length; e++)
                        B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)),
                            X += B[e],
                            f += a[e] ? a[e].margin : 0;
                else
                ...
                if (c && 0 < c.length)
                    for (r = [],
                             e = T = 0; e < c.length; e++)
                        r.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)),
                            T += r[e],
                            K += c[e] ? c[e].margin : 0;
                else
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        b[e].lineCoordinates = {},
                            ...
                            l = Math.round(g.x2 - T - K > p.width - 10 ? p.width - 10 : g.x2 - T - K),
                        b[e].labelAutoFit && !y(t) && (0 < !a.length && (k = 0 > b[e].labelAngle ? Math.max(k, t) : 0 === b[e].labelAngle ? Math.max(k, t / 2) : k),
                        0 < !c.length && (l = 0 < b[e].labelAngle ? l - u / 2 : 0 === b[e].labelAngle ? l - u / 2 : l)),
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++)
                        d[e].lineCoordinates = {},
                            k = Math.round(g.x1 + X + f),
                            l = Math.round(g.x2 - T - K > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - T - K),
                        d[e] && d[e].labelAutoFit && !y(v) && (0 < !a.length && (k = 0 < d[e].labelAngle ? Math.max(k, v) : 0 === d[e].labelAngle ? Math.max(k, v / 2) : k),
                        0 < !c.length && (l -= z / 2)),
                ...
                if (b && 0 < b.length)
                    for (x = [],
                             e = O = 0; e < b.length; e++)
                        x.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)),
                            O += x[e] + b[e].margin,
                            D += b[e].margin;
                else
                    x.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                s.push(x);
                if (d && 0 < d.length)
                    for (A = [],
                             e = S = 0; e < d.length; e++)
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        0 < b[e]._labels.length && (m = b[e]._labels[0],
                            h = b[e]._labels[b[e]._labels.length - 1],
                            t = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++)
                        d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0],
                            h = d[e]._labels[d[e]._labels.length - 1],
                            v = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                ...
                if (p.panEnabled)
                    for (e = 0; e < b.length; e++)
                        x[e] = p.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++)
                        p.sessionVariables.axisY.height = x[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--)
                        h = Math.round(g.y2),
                            m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2),
                            b[e].lineCoordinates.y1 = h - (x[e] + b[e].margin + M),
                            b[e].lineCoordinates.y2 = h - (x[e] + b[e].margin + M),
                            b[e].bounds = {
                                x1: k,
                ...
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--)
                        d[e] && (h = Math.round(g.y1),
                            m = Math.round(g.y1 + (A[e] + d[e].margin + P)),
                            d[e].lineCoordinates.y1 = m,
                            d[e].lineCoordinates.y2 = m,
                            d[e].bounds = {
                                x1: k,
                                y1: h + (d[e].margin + P),
                                x2: l,
                    ...
                    for (e = 0; e < a.length; e++) {
                        ...
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++)
                                b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, t) : 0 === b[D].labelAngle ? Math.max(l, t / 2) : l,
                                    k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - X : k);
                        if (d && 0 < d.length)
                            for (D = 0; D < d.length; D++)
                                d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x1,
                                    k = l - X);
                        a[e].lineCoordinates = {
                            x1: l - J,
                            y1: h,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++)
                                b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, t) : 0 === b[D].labelAngle ? Math.max(l, t / 2) : l,
                                    k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - T : k);
                        if (d && 0 < d.length)
                            for (D = 0; D < d.length; D++)
                                d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x2,
                                    k = l - T);
                        c[e].lineCoordinates = {
                            x1: l + N,
                            y1: h,
    ...
    C.prototype.renderLabelsTicksAndTitle = function() {
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, k = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        ...
                        if (p.position < this.viewportMinimum)
                            break;
                        p.position > this.viewportMaximum || !(l === this._labels.length - 1 || g < Math.log(k / p.position) * h / d) || (c.push(p),
                            k = p.position,
                            g = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++)
                        p = this._labels[l],
                        p.position < this.viewportMinimum || (p = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            c += p);
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], m, k = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        ...
                        if (p.position < this.viewportMinimum)
                            break;
                        p.position > this.viewportMaximum || !(l === this._labels.length - 1 || m < Math.log(k / p.position) * h) || (c.push(p),
                            k = p.position,
                    ...
                    for (l = 0; l < this._labels.length; l++)
                        p = this._labels[l],
                        p.position < this.viewportMinimum || (p = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += p);
        ...
        if ("bottom" === this._position) {
            for (var p, l = 0; l < this._labels.length; l++)
                p = this._labels[l],
                p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position),
                a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                    ...
                    this.ctx.stroke()),
                    0 === p.textBlock.angle ? (b.x -= p.textBlock.width / 2,
                        b.y += this.tickLength + p.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                        b.y += this.tickLength + Math.abs(0 > this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                    p.textBlock.x = b.x,
                    p.textBlock.y = b.y,
            ...
            for (l = 0; l < this._labels.length; l++)
                ...
                a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                    ...
                    this.ctx.stroke()),
                    0 === p.textBlock.angle ? (b.x -= p.textBlock.width / 2,
                        b.y -= this.tickLength + p.textBlock.height / 2) : (b.x += (p.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                        b.y -= this.tickLength + (p.textBlock.height / 2 * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))),
                    p.textBlock.x = b.x,
                    p.textBlock.y = b.y,
                    p.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (l = 0; l < this._labels.length; l++)
                ...
                a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                    ...
                    this.ctx.stroke()),
                    0 === this.labelAngle ? (p.textBlock.y = b.y,
                        p.textBlock.x = b.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5) : (p.textBlock.y = b.y - p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                        p.textBlock.x = 0 < this.labelAngle ? b.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : b.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength),
                    p.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (l = 0; l < this._labels.length; l++)
                ...
                a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                    ...
                    this.ctx.stroke()),
                    0 === this.labelAngle ? (p.textBlock.y = b.y,
                        p.textBlock.x = b.x + this.tickLength + 5) : (p.textBlock.y = 0 > this.labelAngle ? b.y : b.y - (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                        p.textBlock.x = 0 < this.labelAngle ? b.x + (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : b.x + this.tickLength + 5),
                    p.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
                    ...
                    if ("outside" === b.stripLine.labelPlacement)
                        ...
                        b.textBlock.angle = -90,
                            "bottom" === this._position ? (b.textBlock.maxWidth = this.options.stripLines[d].labelMaxWidth ? this.options.stripLines[d].labelMaxWidth : this.chart.plotArea.height - 3,
                                ...
                                a.x - b.textBlock.height > this.chart.plotArea.x1 ? y(m.startValue) ? a.x -= b.textBlock.height - b.textBlock.fontSize / 2 : a.x -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3 : (b.textBlock.angle = 90,
                                    y(m.startValue) ? a.x += b.textBlock.height - b.textBlock.fontSize / 2 : a.x += b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3),
    ...
    C.prototype.calculateAxisParameters = function() {
        if (this.logarithmic)
            ...
            if ("axisX" === this.type) {
                ...
                0 === g - f && (d = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval,
                    g += d,
                    f -= d);
                Infinity !== this.dataInfo.minDiff ? k = this.dataInfo.minDiff : 1 < g - f ? k = 0.5 * Math.abs(g - f) : (k = 1,
                b && (c = !0))
            } else
                "axisY" === this.type && (f = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
                    g = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
                    isFinite(f) || isFinite(g) ? isFinite(f) ? isFinite(g) || (g = f) : f = g : (g = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                        f = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                    0 === f && 0 === g ? (g += 9,
                        f = 0) : 0 === g - f ? (d = Math.min(Math.abs(0.01 * Math.abs(g)), 5),
                        g += d,
                        f -= d) : f > g ? (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 5),
                        0 <= g ? f = g - d : g = isFinite(f) ? f + d : 0) : (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 0.05),
                    0 !== g && (g += d),
                    0 !== f && (f -= d)),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1,
            ...
            if ("axisX" === this.type && b) {
                this.intervalType || (d / 1 <= a ? (this.interval = 1,
                    this.intervalType = "millisecond") : d / 2 <= a ? (this.interval = 2,
                    this.intervalType = "millisecond") : d / 5 <= a ? (this.interval = 5,
                    this.intervalType = "millisecond") : d / 10 <= a ? (this.interval = 10,
                    this.intervalType = "millisecond") : d / 20 <= a ? (this.interval = 20,
                    this.intervalType = "millisecond") : d / 50 <= a ? (this.interval = 50,
                    this.intervalType = "millisecond") : d / 100 <= a ? (this.interval = 100,
                    this.intervalType = "millisecond") : d / 200 <= a ? (this.interval = 200,
                    this.intervalType = "millisecond") : d / 250 <= a ? (this.interval = 250,
                    this.intervalType = "millisecond") : d / 300 <= a ? (this.interval = 300,
                    this.intervalType = "millisecond") : d / 400 <= a ? (this.interval = 400,
                    this.intervalType = "millisecond") : d / 500 <= a ? (this.interval = 500,
                    this.intervalType = "millisecond") : d / (1 * H.secondDuration) <= a ? (this.interval = 1,
                    this.intervalType = "second") : d / (2 * H.secondDuration) <= a ? (this.interval = 2,
                    this.intervalType = "second") : d / (5 * H.secondDuration) <= a ? (this.interval = 5,
                    this.intervalType = "second") : d / (10 * H.secondDuration) <= a ? (this.interval = 10,
                    this.intervalType = "second") : d / (15 * H.secondDuration) <= a ? (this.interval = 15,
                    this.intervalType = "second") : d / (20 * H.secondDuration) <= a ? (this.interval = 20,
                    this.intervalType = "second") : d / (30 * H.secondDuration) <= a ? (this.interval = 30,
                    this.intervalType = "second") : d / (1 * H.minuteDuration) <= a ? (this.interval = 1,
                    this.intervalType = "minute") : d / (2 * H.minuteDuration) <= a ? (this.interval = 2,
                    this.intervalType = "minute") : d / (5 * H.minuteDuration) <= a ? (this.interval = 5,
                    this.intervalType = "minute") : d / (10 * H.minuteDuration) <= a ? (this.interval = 10,
                    this.intervalType = "minute") : d / (15 * H.minuteDuration) <= a ? (this.interval = 15,
                    this.intervalType = "minute") : d / (20 * H.minuteDuration) <= a ? (this.interval = 20,
                    this.intervalType = "minute") : d / (30 * H.minuteDuration) <= a ? (this.interval = 30,
                    this.intervalType = "minute") : d / (1 * H.hourDuration) <= a ? (this.interval = 1,
                    this.intervalType = "hour") : d / (2 * H.hourDuration) <= a ? (this.interval = 2,
                    this.intervalType = "hour") : d / (3 * H.hourDuration) <= a ? (this.interval = 3,
                    this.intervalType = "hour") : d / (6 * H.hourDuration) <= a ? (this.interval = 6,
                    this.intervalType = "hour") : d / (1 * H.dayDuration) <= a ? (this.interval = 1,
                    this.intervalType = "day") : d / (2 * H.dayDuration) <= a ? (this.interval = 2,
                    this.intervalType = "day") : d / (4 * H.dayDuration) <= a ? (this.interval = 4,
                    this.intervalType = "day") : d / (1 * H.weekDuration) <= a ? (this.interval = 1,
                    this.intervalType = "week") : d / (2 * H.weekDuration) <= a ? (this.interval = 2,
                    this.intervalType = "week") : d / (3 * H.weekDuration) <= a ? (this.interval = 3,
                    this.intervalType = "week") : d / (1 * H.monthDuration) <= a ? (this.interval = 1,
                    this.intervalType = "month") : d / (2 * H.monthDuration) <= a ? (this.interval = 2,
                    this.intervalType = "month") : d / (3 * H.monthDuration) <= a ? (this.interval = 3,
                    this.intervalType = "month") : d / (6 * H.monthDuration) <= a ? (this.interval = 6,
                    this.intervalType = "month") : (this.interval = d / (1 * H.yearDuration) <= a ? 1 : d / (2 * H.yearDuration) <= a ? 2 : d / (4 * H.yearDuration) <= a ? 4 : Math.floor(C.getNiceNumber(d / (a - 1), !0) / H.yearDuration),
                    this.intervalType = "year"));
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                    this.viewportMinimum = f - k / 2;
                ...
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                    this.viewportMinimum = "axisX" === this.type ? f - k / 2 : Math.floor(f / this.interval) * this.interval;
                if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            ...
            if (null === this.minimum || null === this.maximum)
                if ("axisX" === this.type ? (f = null !== this.minimum ? this.minimum : this.dataInfo.min,
                        g = null !== this.maximum ? this.maximum : this.dataInfo.max,
                    0 === g - f && (d = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval,
                        g += d,
                        f -= d),
                        k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1) : "axisY" === this.type && (f = null !== this.minimum ? this.minimum : this.dataInfo.min,
                            g = null !== this.maximum ? this.maximum : this.dataInfo.max,
                            isFinite(f) || isFinite(g) ? 0 === f && 0 === g ? (g += 9,
                                f = 0) : 0 === g - f ? (d = Math.min(Math.abs(0.01 * Math.abs(g)), 5),
                                g += d,
                                f -= d) : f > g ? (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 5),
                                0 <= g ? f = g - d : g = isFinite(f) ? f + d : 0) : (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 0.05),
                            0 !== g && (g += d),
                            0 !== f && (f -= d)) : (g = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                                f = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                            k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1,
                    ...
                    this.intervalType = "number",
                    null === this.minimum && (this.minimum = "axisX" === this.type ? f - k / 2 : Math.floor(f / this.interval) * this.interval,
    ...
    C.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = C.getNiceExponent(Math.log(k) / c / (a - 1), !0),
        ...
        this.options && "undefined" === typeof this.options.interval && (this.interval = C.getNiceExponent(Math.ceil(Math.log(k) / c) / (a - 1)),
    ...
    na.prototype.createUserOptions = function(a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder) {
            ...
            this.options._isPlaceholder || (qa(this.parent.stripLines),
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) && f.objectType && "dataPoint" === f.objectType) {
                ...
                "undefined" !== typeof f.y2 && (g = d.getMarkerProperties(k, f.x1, f.y2, this.chart.overlaidCanvasCtx),
                    ...
                    c.globalAlpha = 0.3,
                    N.drawMarkers([g]),
                    c.globalAlpha = 1) : "column" === d.type || "stackedColumn" === d.type || "stackedColumn100" === d.type || "bar" === d.type || "rangeBar" === d.type || "stackedBar" === d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? M(c, f.x1, f.y1, f.x2, f.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? Ga(c, f.center, f.radius, "white", d.type, f.startAngle, f.endAngle, 0.3, f.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1,
        ...
        if (k && (this.content && "function" === typeof this.content || this.contentFormatter))
            ...
            for (var l = null, m = "", h = 0; h < a.length; h++)
                if (b = a[h].dataSeries,
                        ...
                        f = a[h].index,
                        g = "",
                    0 === h && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? m += "undefined" !== typeof this.chart.axisX[0].labels[d.x] ? this.chart.axisX[0].labels[d.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (m += "undefined" !== typeof this.chart.axisX2[0].labels[d.x] ? this.chart.axisX2[0].labels[d.x] : "{x}"),
                        m += "</br>",
                        m = this.chart.replaceKeywordsWithValue(m, d, b, f)),
                    ...
                    if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type)
                        this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                            g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}",
                            l = b.axisXIndex;
                    else if ("bubble" === b.type)
                        this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                            g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
                    else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type)
                        this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                            g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
            ...
            if (null === d.toolTipContent || "undefined" === typeof d.toolTipContent && null === b.options.toolTipContent)
                return null;
            if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type)
                g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === b.type)
                g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            else if ("pie" === b.type || "doughnut" === b.type || "funnel" === b.type)
                g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.name ? "{name}:</span>&nbsp;&nbsp;" : d.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}";
            else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type)
                g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === b.type || "ohlc" === b.type)
                g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
            null === c && (c = "");
            ...
            if ("x" === a)
                if ("dateTime" === g.plotInfo.axisXValueType || "dateTime" === b.xValueType || c.x && c.x.getTime) {
                    if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                        return Ea(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : "DD MMM YY", g._cultureInfo)
                } else
                    return ca(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo);
            else
                return "y" === a ? ca(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" === a ? ca(h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
        })
    }
    ;
    ...
    var E = {
        ...
        formatNumber: function(a, c, b) {
            b = b || "en";
            if (pa[b])
                return ca(a, c || "#,##0.##", new oa(b));
            throw "Unknown Culture Name";
        },
        formatDate: function(a, c, b) {
            b = b || "en";
            if (pa[b])
                return Ea(a, c || "DD MMM YYYY", new oa(b));
            throw "Unknown Culture Name";
        }
    };
